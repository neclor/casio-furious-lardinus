...
The format is specific to PythonExtra but does not depend on the machine
architecture, so the data can be transferred and used on a different PythonExtra
