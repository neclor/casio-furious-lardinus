...
_textures: "dict[str, GintTexture]" = {}
...
def load_texture(path: str) -> "GintTexture":
...
def load_font(path: str, size: int) -> "GintFont":
...
def clear(color: "Color") -> None: gint.dclear(_to_gint_color(color))


def draw_rect(rect: "Rect2", color: "Color", z: int = 0) -> None: _commands.append((z, _blit_rect, (rect, color)))


def draw_text(font: "GintFont", text: str, position: "Vector2", color: "Color", z: int = 0) -> None: _commands.append((z, _blit_text, (font, text, position, color)))
...
def _blit_rect(rect: "Rect2", color: "Color") -> None:
    gint.drect(
        int(rect.position.x),
        int(rect.position.y),
...
def _blit_text(font: GintFont, text: str, position: "Vector2", color: "Color") -> None:
