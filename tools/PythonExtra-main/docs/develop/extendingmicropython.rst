...
Extending PythonExtra in C
==========================

This chapter describes options for implementing additional functionality in C, but from code
written outside of the main PythonExtra repository. The first approach is useful for building
...
live in the main PythonExtra repository.
