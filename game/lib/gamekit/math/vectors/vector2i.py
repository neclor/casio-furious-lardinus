...
class Vector2i:
    ...
    def __sub__(self, o: "Vector2i") -> "Vector2i": return Vector2i(self.x - o.x, self.y - o.y)
    ...
    def __rmul__(self, o: int) -> "Vector2i": return Vector2i(self.x * o, self.y * o)
    ...
    def __iadd__(self, o: "Vector2i") -> "Vector2i":
        self.x += o.x
        self.y += o.y
        return self

    def __isub__(self, o: "Vector2i") -> "Vector2i":
        self.x -= o.x
        self.y -= o.y
        return self

    def __imul__(self, o: "Vector2i | int") -> "Vector2i":
        if isinstance(o, Vector2i):
            self.x *= o.x
            self.y *= o.y
        else:
    ...
    def __itruediv__(self, o: "Vector2i | int") -> "Vector2i":
        if isinstance(o, Vector2i):
    ...
    def __imod__(self, o: "Vector2i | int") -> "Vector2i":
        if isinstance(o, Vector2i):
    ...
    def __eq__(self, o: object) -> bool: return isinstance(o, Vector2i) and self.x == o.x and self.y == o.y

    def __ne__(self, o: object) -> bool: return not (isinstance(o, Vector2i) and self.x == o.x and self.y == o.y)

    def __hash__(self) -> int: return hash((self.x, self.y))

    def __lt__(self, o: "Vector2i") -> bool: return self.y < o.y if self.x == o.x else self.x < o.x

    def __le__(self, o: "Vector2i") -> bool: return self.y <= o.y if self.x == o.x else self.x < o.x

    def __gt__(self, o: "Vector2i") -> bool: return self.y > o.y if self.x == o.x else self.x > o.x

    def __ge__(self, o: "Vector2i") -> bool: return self.y >= o.y if self.x == o.x else self.x > o.x
    ...
    def __repr__(self) -> str: return "Vector2i({}, {})".format(self.x, self.y)
